		...
		<div class="container">
			<div class="row mt-5 mb-2">
				<div class="col-sm p-0">
					<s:form action="/filtrarExamesRealizado.action">
			...
			<div class="row mt-5 mb-2">
				<table class="table table-hover">
					<thead style="background-color: #46A6AF; color: white;">
						<tr>
							...
							<th><s:text name="Nome Exame"/></th>
                            <th><s:text name="Nome Funcionario"/></th>
                            <th><s:text name="Data"/></th>
							<th class="text-end mt-5"><s:text name="label.acao"/></th>
						</tr>
					</thead>

					<tbody>
						<s:iterator value="realizado" >
							<tr>
								 <td>${codigoExameRealizado}</td>
								 <td>${nomeExame}</td>
                                 <td>${nomeFuncionario}</td>
                                 <td>${dataExameRealizado}</td>
								<td class="text-end">
									<s:url action="editarExameRealizado" var="editar">
										<s:param name="exameRealizadoVo.codigoExameRealizado" value="codigoExameRealizado"></s:param>
									</s:url>

									<a href="${editar}" class="btn btn-warning text-white">
										<s:text name="label.editar"/>
									</a>
                                    <s:url action="excluirExameRealizado" var="excluir">
										<s:param name="exameRealizadoVo.codigoExameRealizado" value="codigoExameRealizado"></s:param>
									</s:url>
                ...
                <s:url action="novoExameRealizado" var="novo"/>
