...
<html>
	<head>
		...
		<title><s:text name="label.titulo.pagina.funcionarios"/></title>
		...
		<div class="container">
			...
			<div class="row mt-5 mb-2">
				<table class="table table-hover">
					...
					<tbody>
						<s:iterator value="funcionario" >
							<tr>
								<td>${codigoFuncionario}</td>
								<td>${nome}</td>
								<td class="text-end">
									<s:url action="editarFuncionarios" var="editar">
										<s:param name="funcionarioVo.codigoFuncionario" value="codigoFuncionario"></s:param>
									</s:url>
